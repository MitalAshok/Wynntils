...
public class NametagManager {
            ...
            if (entityTeam != null) {
                ...
                switch (visibility) {
                    ...
                    case HIDE_FOR_OTHER_TEAMS:
                        return playerTeam == null ? isVisible : entityTeam.isSameTeam(playerTeam) && (entityTeam.getSeeFriendlyInvisiblesEnabled() || isVisible);
                    case HIDE_FOR_OWN_TEAM:
                        return playerTeam == null ? isVisible : !entityTeam.isSameTeam(playerTeam) && isVisible;
                }
            }
        }
    ...
    /**
     * Handles the nametags drawing, if you want to add more tags use
     * checkForNametags
     */
        ...
        pushMatrix();
        {
            ...
            ScreenRenderer.beginGL(0, 0); // we set to 0 because we don't want the ScreenRender to handle this thing
            {
                ...
                if (!isSneaking && color != null) {
                    if (!UtilitiesConfig.INSTANCE.hideNametags) renderer.drawString(input, -middlePos, verticalShift, color, SmartFontRenderer.TextAlignment.LEFT_RIGHT, SmartFontRenderer.TextShadow.NONE);
                    ...
                    if (!UtilitiesConfig.INSTANCE.hideNametags) fontRenderer.drawString(input, -middlePos, verticalShift, isSneaking ? 553648127 : -1);
    ...
    private static List<NametagLabel> getUserArmorLabels(EntityPlayer player) {
        ...
        for (ItemStack is : player.getEquipmentAndArmor()) {
            ...
            switch (itemProfile.getTier()) {
                case MYTHIC:
                    color = MinecraftChatColors.DARK_PURPLE;
                    break;
                case FABLED:
                ...
                case LEGENDARY:
                    ...
                    break;
                case RARE:
                    color = MinecraftChatColors.LIGHT_PURPLE;
                    break;
                case UNIQUE:
